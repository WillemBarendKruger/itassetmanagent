...
namespace shesha.app.Common.Authorization
{
    /// <summary>
    /// app Permission checker
    /// </summary>
    public class appPermissionChecker : ICustomPermissionChecker, IappPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public appPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
