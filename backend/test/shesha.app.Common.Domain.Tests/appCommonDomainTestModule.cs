...
using shesha.app.Tests.DependencyInjection;
using Shesha;
...
namespace shesha.app.Common.Tests
{
    [DependsOn(
        typeof(appModule),
    ...
    public class appCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public appCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
